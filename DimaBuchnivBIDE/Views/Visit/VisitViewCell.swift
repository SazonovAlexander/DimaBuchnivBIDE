...
final class VisitViewCell: UITableViewCell {
    static let reuseIdentifier: String = "VisitViewCell"
    ...
    //MARK: - Public Methods
    func setupCell(visit: VisitResponse) {
        descriptionLabel.text = "\(visit.dateVisit)\nПациент: \(visit.patient.fio)\nВрач: \(visit.doctor.fio)"
    }
